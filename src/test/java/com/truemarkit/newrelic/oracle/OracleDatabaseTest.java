...
public class OracleDatabaseTest {
	...
	public void testGetConnection() {
		...
		Connection con = DatabaseUtil.getConnection("localhost", "1521", "xe", null, "scott", "tiger");
		assertNotNull(con);
	}
