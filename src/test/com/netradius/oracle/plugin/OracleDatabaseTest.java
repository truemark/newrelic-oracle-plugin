...
public class OracleDatabaseTest {
	...
	public void testGetConnection() {
		...
		Connection con = DatabaseUtil.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "scott", "tiger");
		assertNotNull(con);
	}

	@Test
	public void testBadHost() {
		Connection con = DatabaseUtil.getConnection("jdbc:oracle:thin:@localost:1521:xe", "scott", "tiger");
		assertNull(con);
	}
